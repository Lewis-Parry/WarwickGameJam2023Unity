...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("WarwickGameJam2023", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("WarwickGameJam2023", null, 1366, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "WarwickGameJam2023";
		app.meta["name"] = "WarwickGameJam2023";
