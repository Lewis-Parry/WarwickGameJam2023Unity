...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("GameJamTest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("GameJamTest", null, 650, 500);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "GameJamTest";
		app.meta["name"] = "GameJamTest";
